...
def coordinate_interpreter(data):
    global _xyz, _new_pos, last_coords
    last_coords = _xyz;
...
def main(motor_object, motor_object2, motor_object3, motor_object4, Q1, Q2, Q3, Q4):
    ...
    while bool_test:
        ...
        zeros_2 = inst_to_coof(Q3-(m.pi/2), zeros, coof) - 3100
        if zeros_2 > 0:
            motor_object4.set_goal_position(mathf_maxi(900, 2800, inst_to_coof(Q4, zeros, coof)+zeros_2))
...
if __name__ == "__main__":
    app.run(host="192.168.0.28", debug=True, port=8080)
